...
public class Constants {
    ...
    public static final int POLLING_INTERVAL_TIME = 5;// 秒

    public static final int ONCE_TIMEOUT = 1000;// 毫秒

    public static final int CONN_TIMEOUT = 3000;// 毫秒

    public static final int RECV_WAIT_TIMEOUT = ONCE_TIMEOUT * 3;// 毫秒

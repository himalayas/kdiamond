...
<form action="${updateConfigUrl}" method="post" id="update-form">
    <table align='center'>
        <tr>
            <td>dataId:</td>
            <td>
                <input readonly="true" type='text' name='dataId' value="${configInfo.dataId}" width="256"
                       class="required max-length-128"/>
            </td>
        </tr>
        <tr>
            <td>group:</td>
            <td><input type='text' readonly="true" name='group' value="${configInfo.group}" width="256"
        ...
        <tr>
            <td colspan="2">
                <textarea cols="100" rows="20" name="content" class="required max-length-65535"><c:out
                        value="${configInfo.content}"/></textarea>
            </td>
        </tr>
        <tr>
